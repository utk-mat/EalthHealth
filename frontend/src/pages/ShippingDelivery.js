...
const ShippingDelivery = () => {
  const deliveryOptions = [
    {
      ...
      description: "Regular delivery service available across India. Orders are processed within 24 hours of prescription verification."
    },
    {
      title: "Express Delivery",
      time: "1 business day",
      price: "₹99",
      description: "Priority processing and delivery for urgent orders. Available in major cities. Orders placed before 2 PM will be delivered the next day."
    },
    {
      title: "Same Day Delivery",
      time: "Same day",
      price: "₹149",
      description: "Available in select metro cities. Orders must be placed before 12 PM for same-day delivery. Subject to prescription verification."
    }
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-primary mb-8">Shipping & Delivery</h1>

      <div className="grid md:grid-cols-3 gap-6 mb-12">
        {deliveryOptions.map((option, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-primary mb-3">{option.title}</h3>
            <p className="text-lg font-medium text-secondary mb-2">{option.time}</p>
      ...
      <div className="mt-12 bg-gray-50 rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-4">
          For any questions about shipping or delivery, please contact our customer service team.
        </p>
        <div className="space-y-2">
          <p className="text-gray-600">📞 Shipping Support: +91 1800-123-4567</p>
