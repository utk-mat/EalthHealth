...
const Contact = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-gray-50 min-h-screen-minus-navbar font-sans">
      <h1 className="text-4xl font-extrabold text-primary-dark text-center mb-10">Contact Us</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        {/* Contact Information */}
        <div className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-primary-dark mb-6">Get in Touch</h2>
          <p className="text-gray-700 mb-4">We'd love to hear from you! Please feel free to reach out with any questions, feedback, or inquiries.</p>
          
          <div className="space-y-4">
            <div className="flex items-center text-gray-700">
              <FaMapMarkerAlt className="text-primary mr-3 text-xl" />
              <p>123 Health Pharmacy Lane, Wellness City, State 12345, Country</p>
            </div>
            <div className="flex items-center text-gray-700">
              <FaPhone className="text-primary mr-3 text-xl" />
              <p><a href="tel:+1234567890" className="hover:text-primary-dark transition duration-200">+1 (234) 567-890</a></p>
            </div>
            <div className="flex items-center text-gray-700">
              <FaEnvelope className="text-primary mr-3 text-xl" />
              <p><a href="mailto:info@healthpharmacy.com" className="hover:text-primary-dark transition duration-200">info@healthpharmacy.com</a></p>
            </div>
          </div>

          <h3 className="text-xl font-semibold text-primary-dark mt-8 mb-4">Business Hours</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="text" id="subject" name="subject" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="Inquiry about an order" />
            </div>
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-gray-700">Your Message</label>
              <textarea id="message" name="message" rows="4" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm" placeholder="Enter your message here..."></textarea>
            </div>
            <button
              type="submit"
      ...
      <div className="mt-10 bg-white rounded-xl shadow-lg overflow-hidden">
        <h2 className="text-2xl font-bold text-primary-dark text-center pt-8 mb-6">Find Us on the Map</h2>
